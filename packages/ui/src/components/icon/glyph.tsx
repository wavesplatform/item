...
export const Glyph = ({ name }: TProps) => {
  switch (name) {
    ...
    case 'waves':
      return (
        <g>
          <path d='M16 32c-8.837 0-16-7.163-16-16s7.163-16 16-16 16 7.163 16 16-7.163 16-16 16zM16 6l-10 10 10 10 10-10z'></path>
        </g>
      )
    case 'add':
      return (
    ...
    case 'compare_arrows':
      return (
        <g>
          <path d='M20.573 17.5l-6.073-6.073 6.073-6.073v4.573h10.646v3.001h-10.646v4.573zM11.427 19.072v-4.573l6.073 6.073-6.073 6.073v-4.573h-10.646v-3.001h10.646z'></path>
        </g>
      )
    case 'mode_edit':
      return (
    ...
    case 'games':
      return (
        <g>
          <path d='M22 12h7.313v8h-7.313l-4-4zM12 22l4-4 4 4v7.313h-8v-7.313zM10 12l4 4-4 4h-7.313v-8h7.313zM20 10l-4 4-4-4v-7.313h8v7.313z'></path>
        </g>
      )
    case 'layers':
      return (
    ...
    case 'tab_unselected':
      return (
        <g>
          <path d='M22.688 28v-2.688h2.625v2.688h-2.625zM17.313 28v-2.688h2.688v2.688h-2.688zM28 17.313v-2.625h2.688v2.625h-2.688zM28 28v-2.688h2.688c0 1.438-1.25 2.688-2.688 2.688zM6.688 6.688v-2.688h2.625v2.688h-2.625zM6.688 28v-2.688h2.625v2.688h-2.625zM12 6.688v-2.688h2.688v2.688h-2.688zM28 22.688v-2.688h2.688v2.688h-2.688zM28 4c1.438 0 2.688 1.25 2.688 2.688v5.313h-13.375v-8h10.688zM4 28c-1.438 0-2.688-1.25-2.688-2.688h2.688v2.688zM1.313 22.688v-2.688h2.688v2.688h-2.688zM12 28v-2.688h2.688v2.688h-2.688zM1.313 6.688c0-1.438 1.25-2.688 2.688-2.688v2.688h-2.688zM1.313 17.313v-2.625h2.688v2.625h-2.688zM1.313 12v-2.688h2.688v2.688h-2.688z'></path>
        </g>
      )
    case 'done':
      return (
        <g>
          <path d='M13.313 22.688l12-12-1.875-1.938-10.125 10.125-4.75-4.75-1.875 1.875zM16 2.688c7.375 0 13.313 5.938 13.313 13.313s-5.938 13.313-13.313 13.313-13.313-5.938-13.313-13.313 5.938-13.313 13.313-13.313z'></path>
        </g>
      )
    case 'error':
      return (
    ...
    case 'feedback':
      return (
        <g>
          <path d='M24 10.688v-2.688h-16v2.688h16zM24 14.688v-2.688h-16v2.688h16zM24 18.688v-2.688h-16v2.688h16zM26.688 2.688c1.438 0 2.625 1.188 2.625 2.625v24l-5.313-5.313h-18.688c-1.438 0-2.625-1.25-2.625-2.688v-16c0-1.438 1.188-2.625 2.625-2.625h21.375z'></path>
        </g>
      )
    case 'warning':
      return (
